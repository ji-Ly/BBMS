...
if("valid".equals(msg)){
	%>
	<center><font color="red" size="5">Update Donor Successfully</font></center>
	<% 
...
%>
	...
	try {
		...
		PreparedStatement preparedStatement = connection.prepareStatement("select max(id) from donor");
	...
	<br>
	<h3>
		<center>All Right Reserved @ hLyY :: 2024</center>
	</h3>
